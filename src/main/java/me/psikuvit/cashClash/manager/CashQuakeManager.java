...
public class CashQuakeManager {
    ...
    public void startEventScheduler() {
        ...
        eventTask = Bukkit.getScheduler().runTaskTimer(CashClashPlugin.getInstance(), () -> {
    ...
    private void triggerRandomEvent() {
        ConfigManager config = ConfigManager.getInstance();
        double supplyDropChance = config.getSupplyDropChance();
    ...
    private void executeEvent(CashQuakeEvent event) {
        ...
        switch (event) {
            case LOTTERY -> message = prefix + " <gold><bold>LOTTERY!</bold> <yellow>Type /lottery to enter (5k coins for 50% chance to double)</yellow>";
            case LIFE_STEAL -> message = prefix + " <red><bold>LIFE STEAL!</bold> <yellow>Kills now grant extra hearts for 2 minutes!</yellow>";
            case CHECK_UP -> message = prefix + " <green><bold>CHECK UP!</bold> <yellow>Everyone receives random bonus hearts!</yellow>";
            case BONUS_JACKPOT -> message = prefix + " <gold><bold>BONUS JACKPOT!</bold> <yellow>Everyone receives bonus money!</yellow>";
            case TAX_TIME -> message = prefix + " <red><bold>TAX TIME!</bold> <yellow>Everyone loses a percentage of their money!</yellow>";
            case MYSTERY_LOOT -> message = prefix + " <purple><bold>MYSTERY LOOT!</bold> <yellow>Everyone receives a random shop item!</yellow>";
            case BROKEN_GEAR -> message = prefix + " <red><bold>BROKEN GEAR!</bold> <yellow>A random piece of equipment disappears for 30 seconds!</yellow>";
            case WEIGHT_OF_WEALTH -> message = prefix + " <gold><bold>WEIGHT OF WEALTH!</bold> <yellow>Pay 5k or lose a random item!</yellow>";
            case SUPPLY_DROP -> message = prefix + " <yellow><bold>SUPPLY DROP!</bold> <green>Rich Man Bobby dropped his riches at coordinates!</green>";
