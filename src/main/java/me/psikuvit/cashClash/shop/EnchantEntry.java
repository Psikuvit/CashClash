...
public enum EnchantEntry {
    ...
    PROTECTION(Enchantment.PROTECTION, "Protection", Map.of(1, 7500L, 2, 15000L, 3, 30000L, 4, 50000L), List.of(Material.IRON_CHESTPLATE, Material.IRON_HELMET, Material.IRON_LEGGINGS, Material.IRON_BOOTS, Material.DIAMOND_CHESTPLATE, Material.DIAMOND_HELMET, Material.DIAMOND_LEGGINGS, Material.DIAMOND_BOOTS, Material.NETHERITE_CHESTPLATE, Material.NETHERITE_HELMET, Material.NETHERITE_LEGGINGS, Material.NETHERITE_BOOTS)),
    PROJECTILE_PROTECTION(Enchantment.PROJECTILE_PROTECTION, "Projectile Protection", Map.of(1, 800L, 2, 1200L, 3, 1600L, 4, 2000L), List.of(Material.IRON_CHESTPLATE, Material.DIAMOND_CHESTPLATE, Material.NETHERITE_CHESTPLATE)),
